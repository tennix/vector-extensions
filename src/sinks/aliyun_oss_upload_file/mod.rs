...
use crate::sinks::aliyun_oss_upload_file::auth::Authentication;
use crate::sinks::aliyun_oss_upload_file::processor::S3UploadFileSink;
...
/// PLACEHOLDER
#[configurable_component(sink("aliyun_oss_upload_file"))]
#[derive(Debug, Clone)]
